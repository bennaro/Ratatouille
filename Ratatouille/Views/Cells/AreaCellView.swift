...
struct AreaCellView: View {
    ...
    var body: some View {
        HStack {
            AsyncImage(url: URL(string: flagImageURLs[recipe.strArea ?? ""] ?? "")) { image in
                image
                    .resizable()
...
//#Preview {
//    AreaCellView(recipe: Recipe(idMeal: "jfkldj", strArea: "Canada"))
//}
